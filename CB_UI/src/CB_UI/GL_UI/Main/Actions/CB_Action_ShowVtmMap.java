 ...
 * @author Longri
 */
public class CB_Action_ShowVtmMap extends CB_Action_ShowView {
...
//                    VtmMapView.that.SetAlignToCompass(!VtmMapView.that.GetAlignToCompass());
                    return true;
...
//                    if (VtmMapView.that != null) {
//                        VtmMapView.that.createWaypointAtCenter();
//                    }
                    return true;
            /*
    ...
    public CB_Action_ShowVtmMap() {
        super("VTM", MenuID.AID_SHOW_VTM_MAP);
    }

    @Override
    public void Execute() {
        if ((TabMainView.vtmMapView == null) && (tabMainView != null) && (tab != null))
            TabMainView.vtmMapView = new VtmMapView(tab.getContentRec());

        if ((TabMainView.vtmMapView != null) && (tab != null))
            tab.ShowView(TabMainView.vtmMapView);
    }

    @Override
    public CB_View_Base getView() {
        return TabMainView.vtmMapView;
    }
...
//        icm.addCheckableItem(MenuID.MI_ALIGN_TO_COMPSS, "AlignToCompass", VtmMapView.that.GetAlignToCompass());
...
//        }
    ...
    private void showMapOverlayMenu() {
        ...
        for (Layer layer : ManagerBase.Manager.getLayers()) {
            if (layer.isOverlay()) {
//                MenuItem mi = icm.addCheckableItem(menuID++, layer.FriendlyName, layer == VtmMapView.mapTileLoader.getCurrentOverlayLayer());
//                mi.setData(layer);
            }
        }
        ...
        icm.addOnClickListener(new OnClickListener() {
            ...
            public boolean onClick(GL_View_Base v, int x, int y, int pointer, int button) {
//                Layer layer = (Layer) ((MenuItem) v).getData();
//                if (layer == VtmMapView.mapTileLoader.getCurrentOverlayLayer()) {
//                    // switch off Overlay
//                    TabMainView.vtmMapView.SetCurrentOverlayLayer(null);
//                } else {
//                    TabMainView.vtmMapView.SetCurrentOverlayLayer(layer);
//                }
                // Refresh menu
                icm.close();
                showMapOverlayMenu();
    ...
    private void toggleSetting(SettingBool setting) {
        ...
        Config.AcceptChanges();
//        if (VtmMapView.that != null)
//            VtmMapView.that.setNewSettings(VtmMapView.INITIAL_SETTINGS_WITH_OUT_ZOOM);
    }
    ...
    private void toggleSettingWithReload(SettingBool setting) {
        ...
        Config.AcceptChanges();
//        if (VtmMapView.that != null)
//            VtmMapView.that.setNewSettings(VtmMapView.INITIAL_WP_LIST);
    }
